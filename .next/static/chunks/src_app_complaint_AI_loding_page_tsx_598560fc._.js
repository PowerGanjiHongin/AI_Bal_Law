    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoadingPage.useEffect": ()=>{
            ...
            const step1 = setTimeout({
                "LoadingPage.useEffect.step1": ()=>setCurrentStep(1)
            }["LoadingPage.useEffect.step1"], 400);
            let p = 0;
            const interval = setInterval({
                "LoadingPage.useEffect.interval": ()=>{
                    p += 1;
                    setProgress(p);
                    ...
                    if (p >= 100) {
                        ...
                        }["LoadingPage.useEffect.interval"], 600);
                    }
                }
            }["LoadingPage.useEffect.interval"], 40);
            return ({
                "LoadingPage.useEffect": ()=>{
                    clearTimeout(step1);
                    clearInterval(interval);
...
_s(LoadingPage, "aW69+xRbv6UFKOhkK43QtY6KD8k=", false, function() {
    return [
